...
/* harmony export (immutable) */ __webpack_exports__["e"] = ADD_TODO;

const TOGGLE_TODO = 'TOGGLE_TODO';
/* harmony export (immutable) */ __webpack_exports__["f"] = TOGGLE_TODO;

const SET_VISIBILITY_FILTER = 'SET_VISIBILITY_FILTER';
/* harmony export (immutable) */ __webpack_exports__["g"] = SET_VISIBILITY_FILTER;


const VisibilityFilters = {
  SHOW_ALL: 'SHOW_ALL',
  SHIW_ACTIVE: 'SHOW_ACTIVE',
...
function todos(state = [], action) {
  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_0__action__["e" /* ADD_TODO */]:
      return [...state, {
        text: action.text,
        completed: false
      }];
    case __WEBPACK_IMPORTED_MODULE_0__action__["f" /* TOGGLE_TODO */]:
...
function visibilityFilter(state = "SHOW_ALL", action) {
  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_0__action__["g" /* SET_VISIBILITY_FILTER */]:
...
const todoApp = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_redux__["b" /* combineReducers */])({ todos, visibilityFilter });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reducer__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__action__ = __webpack_require__(0);




const store = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux__["a" /* createStore */])(__WEBPACK_IMPORTED_MODULE_1__reducer__["a" /* default */]);
...
store.dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__action__["a" /* addTodo */])('Learn about actions'));
store.dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__action__["a" /* addTodo */])('Learn about reducers'));
store.dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__action__["a" /* addTodo */])('Learn about stores'));
store.dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__action__["b" /* toggleTodo */])(0));
store.dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__action__["b" /* toggleTodo */])(1));
store.dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__action__["c" /* setVisibilityFilter */])(__WEBPACK_IMPORTED_MODULE_2__action__["d" /* VisibilityFilters */].SHOW_COMPLETED));
